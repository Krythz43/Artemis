...
class NewsDisplayViewController :UITableViewController, chooseCategoryDelegate, querySearchDelegate, geoSearchDelegate, getNewsDelegate, categorySourceDelegate, setFiltersDelegate, refreshNewsDelegate{
